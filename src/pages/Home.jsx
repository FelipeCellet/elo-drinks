...
function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center bg-black text-white min-h-screen space-y-10 px-4 pt-10">
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        <button
          ...
          className="bg-gray-800 text-white px-6 py-3 rounded-lg text-lg font-medium hover:bg-gray-700 transition"
        >
          Montar Meu Pacote
        </button>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-4 space-y-10">
          <div className="space-y-4 text-center">
            ...
            <p className="text-gray-300">
              ...
              Alcançamos o perfil que cada celebração exige com a CUSTOMIZAÇÃO dos nossos serviços e drinks — da coquetelaria clássica à contemporânea, tornando seu evento memorável!
            </p>
            <p className="text-gray-300">
